       ...
       /*  // TODO: Start new thread and process data from/to connection
        {
            ...
            {
                workers.insert(std::pair<int, std::thread>(client_socket, std::thread(&ServerImpl::Connection, this, client_socket)));
            }
            else
            {
                close(client_socket);
...
void ServerImpl::Connection(int client_socket) {
    ...
    std::unique_ptr<Execute::Command> command_to_execute;
        ...
        //Finish connection: delete this worker, close client_socket
